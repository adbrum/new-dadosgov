...
| **37** | LEDG-2469 §15 | **Fundir os duplicados que já existem** e impedi-los na BD | Backend + Operação | ❌ Não | 🔗 **O lado operacional do 35.** Contas que partilham identificador não conseguem sequer entrar — o login recusa por ambiguidade — logo não é self-service. 🛑 Depende de decisões da AMA |
