...
| **11** | LEDG-2434 §5a | O script de levantamento **versionado**, com os dois eixos de colisão | Spike | ✅ **09-09** — PR #264 | 🚩 **Metade do LEDG-2434, e a primeira coisa feita depois do LEDG-2349** — a tabela antiga escondia-o ao mostrar só a segunda metade |
