...
> - **31 a 41** — o que vem a seguir, **pela ordem de o fazer**, sem bloqueio externo
...
> - **42 a 43** — sequenciado: a ordem entre eles importa mais do que qualquer data
>
...
| **42** | LEDG-2471 §19 | **Descontinuar o login por email e palavra-passe** | Full-stack | ❌ Não | Depende do **15**, **17**, **18**, do LEDG-2437 e do **LEDG-2474**. ⚠️ **E agora do 12** — enquanto as institucionais dependerem do login tradicional, descontinuá-lo tira-lhes a via de entrada |
| **43** | LEDG-1277 §20 | **Obrigatoriedade do Autenticação.gov** — o fim do arco | Produto | 🟡 Em curso | Depende do **19**. ⚠️ **Não activar antes dele** |
